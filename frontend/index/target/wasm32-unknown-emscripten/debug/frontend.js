...
function integrateWasmJS() {
  ...
  var wasmTextFile = 'frontend.wast';
  var wasmBinaryFile = 'frontend.wasm';
  var asmjsCodeFile = 'frontend.temp.asm.js';
...
var ASM_CONSTS = [function($0) { return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof MouseEvent) | 0; },
 function($0) { return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof HTMLTextAreaElement) | 0; },
 function($0, $1) { $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). value ;})()); },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0). value = ($1); },
 function($0) { $0 = Module.STDWEB_PRIVATE.to_js($0);($0). stopPropagation (); },
 function($0, $1) { $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). clientX ;})()); },
 function($0, $1) { $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). clientY ;})()); },
 function($0, $1) { $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). screenX ;})()); },
 function($0, $1) { $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). screenY ;})()); },
 function($0) { return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof HTMLInputElement) | 0; },
 ...
 function($0, $1) { $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). nextSibling ;})()); },
 function($0, $1) { $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). classList ;})()); },
 function($0) { Module.STDWEB_PRIVATE.increment_refcount( $0 ); },
 function($0) { Module.STDWEB_PRIVATE.decrement_refcount( $0 ); },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0). type = ($1); },
 function($0) { $0 = Module.STDWEB_PRIVATE.to_js($0);($0). type = "" ; },
 function($0) { return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof Event) | 0; },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0). nodeValue = ($1); },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0). appendChild (($1)); },
 function($0, $1, $2) { $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){try {return {value : function (){return ($1). removeChild (($2));}(), success : true};}catch (error){return {error : error , success : false};}})()); },
 ...
 function($0, $1, $2, $3) { $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);$3 = Module.STDWEB_PRIVATE.to_js($3);Module.STDWEB_PRIVATE.from_js($0, (function(){try {return {value : function (){return ($1). insertBefore (($2), ($3));}(), success : true};}catch (error){return {error : error , success : false};}})()); },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);var bind = ($0); var callback = ($1); bind.loop = callback ; },
 function($0) { $0 = Module.STDWEB_PRIVATE.to_js($0);var bind = ($0); window._yew_schedule_ (bind); },
 function($0) { Module.STDWEB_PRIVATE.from_js($0, (function(){return {"loop" : function (){}};})()); },
 function($0) { Module.STDWEB_PRIVATE.tmp = Module.STDWEB_PRIVATE.to_js( $0 ); },
 function($0) { $0 = Module.STDWEB_PRIVATE.to_js($0);console.log (($0)); },
 function($0) { Module.STDWEB_PRIVATE.from_js($0, (function(){var task = null ; var pool = []; var routine = function (){}; var schedule_routine = function (){if (task == null){task = setTimeout (routine);}}; routine = function (){task = null ; var limit = 25 ; var callback = pool.pop (); while (callback !==undefined){callback.loop (); limit = limit - 1 ; if (limit > 0){callback = pool.pop ();}else {break ;}}if (pool.length > 0){schedule_routine ();}}; var schedule = function (callback){pool.push (callback); schedule_routine ();}; window._yew_schedule_ = schedule ;})()); },
 function($0, $1) { $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). lastChild ;})()); },
 function($0, $1, $2) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);($0). setAttribute (($1), ($2)); },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0). removeAttribute (($1)); },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0). checked = ($1); },
 function($0) { $0 = Module.STDWEB_PRIVATE.to_js($0);var destroy = function (){var bind = ($0); bind.loop.drop (); bind.loop = function (){};}; setTimeout (destroy , 0); },
 ...
 function($0) { return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof Node) | 0; },
 function($0) { return (Module.STDWEB_PRIVATE.acquire_js_reference( $0 ) instanceof Element) | 0; },
 ...
 function($0, $1, $2) { $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). createTextNode (($2));})()); },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0). add (($1)); },
 function($0, $1) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);($0). remove (($1)); },
 function($0, $1, $2) { $0 = Module.STDWEB_PRIVATE.to_js($0);$1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);var listener = ($0); ($1). removeEventListener (($2), listener); listener.drop (); },
 function($0) { var r = Module.STDWEB_PRIVATE.acquire_js_reference( $0 );return (r instanceof DOMException) && (r.name === "HierarchyRequestError"); },
 function($0) { var r = Module.STDWEB_PRIVATE.acquire_js_reference( $0 );return (r instanceof DOMException) && (r.name === "NotFoundError"); },
 function($0) { var value = Module.STDWEB_PRIVATE.get_raw_value( $0 );return Module.STDWEB_PRIVATE.register_raw_value( value ); },
...
function nullFunc_viiiiji(x) { Module["printErr"]("Invalid function pointer called with signature 'viiiiji'. Perhaps this is an invalid value (e.g. caused by calling a virtual method on a NULL pointer)? Or calling a function with an incorrect type, which will fail? (it is worth building your source files with -Werror (warnings are errors), as warnings can indicate undefined behavior which can cause this)");  Module["printErr"]("Build with ASSERTIONS=2 for more info.");abort(x) }
...
Module['wasmTableSize'] = 34816;

Module['wasmMaxTableSize'] = 34816;
